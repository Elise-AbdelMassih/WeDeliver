...
#predefined graph of neighboring cities
cities["Akkar"].neighbors = [cities["Tripoli"], cities["Bcharre"]]
cities["Tripoli"].neighbors = [cities["Akkar"], cities["Bcharre"]]
cities["Jbeil"].neighbors = [cities["Batroun"], cities["Zahle"]]
cities["Zahle"].neighbors = [cities["Saida"], cities["Jbeil"]]
cities["Bcharre"].neighbors = [cities["Tripoli"], cities["Jounieh"]]
cities["Batroun"].neighbors = [cities["Jbeil"], cities["Tripoli"]]
cities["Sour"].neighbors = [cities["Saida"], cities["Jezzine"]]
cities["Jounieh"].neighbors = [cities["Bcharre"], cities["Zahle"]]
cities["Saida"].neighbors = [cities["Zahle"], cities["Sour"]]
cities["Jezzine"].neighbors = [cities["Saida"], cities["Sour"]]
